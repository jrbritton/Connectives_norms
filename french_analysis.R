...
setwd("C:\\Users\\herts\\OneDrive\\Desktop\\Manu\\data")
...
frenchData1a <- frenchData[c(1:5), c(1,4,5,7,10:89)]
frenchData1b <- frenchData[c(6:11), c(1,4,5,7,100:166)]
frenchData2a <- frenchData[c(12:16), c(1,4,5,7,167:246)]
frenchData2b <- frenchData[c(17:21), c(1,4,5,7,247:323)]
frenchData3a <- frenchData[c(22:26), c(1,4,5,7,324:403)]
frenchData3b <- frenchData[c(27:32), c(1,4,5,7,404:480)]
frenchData4a <- frenchData[c(33:38), c(1,4,5,7,481:560)]
frenchData4b <- frenchData[c(39:44), c(1,4,5,7,561:637)]

# Melt data to long format

frenchData1a <- reshape2::melt(frenchData1a, id.vars = c(1:4))
colnames(frenchData1a)[colnames(frenchData1a)=="variable"] = "Item"
colnames(frenchData1a)[colnames(frenchData1a)=="value"] = "Score"

frenchData1b <- reshape2::melt(frenchData1b, id.vars = c(1:4))
colnames(frenchData1b)[colnames(frenchData1b)=="variable"] = "Item"
colnames(frenchData1b)[colnames(frenchData1b)=="value"] = "Score"

frenchData2a <- reshape2::melt(frenchData2a, id.vars = c(1:4))
colnames(frenchData2a)[colnames(frenchData2a)=="variable"] = "Item"
colnames(frenchData2a)[colnames(frenchData2a)=="value"] = "Score"

frenchData2b <- reshape2::melt(frenchData2b, id.vars = c(1:4))
colnames(frenchData2b)[colnames(frenchData2b)=="variable"] = "Item"
colnames(frenchData2b)[colnames(frenchData2b)=="value"] = "Score"

frenchData3a <- reshape2::melt(frenchData3a, id.vars = c(1:4))
colnames(frenchData3a)[colnames(frenchData3a)=="variable"] = "Item"
colnames(frenchData3a)[colnames(frenchData3a)=="value"] = "Score"

frenchData3b <- reshape2::melt(frenchData3b, id.vars = c(1:4))
colnames(frenchData3b)[colnames(frenchData3b)=="variable"] = "Item"
colnames(frenchData3b)[colnames(frenchData3b)=="value"] = "Score"

frenchData4a <- reshape2::melt(frenchData4a, id.vars = c(1:4))
colnames(frenchData4a)[colnames(frenchData4a)=="variable"] = "Item"
colnames(frenchData4a)[colnames(frenchData4a)=="value"] = "Score"

frenchData4b <- reshape2::melt(frenchData4b, id.vars = c(1:4))
